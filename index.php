    ...
    <?php $pageTitle = "PL Starter Template - Home"; include("includes/header.php"); ?>  <!-- this pulls the header.php file from the includes folder and adds a title to the page-->
    
    <section class="mainGraphic"> 
    ...
    <section class="highlights"> 
    	<div class="container_12 clearfix">
        	<a id="hLink1" href="#" class="grid_4 cms-editable"> <!-- states that I want my content to be only 4 columns of the grid -->
            	<h2 id="hLinkTitle1" class="cms-editable-text">Magna Aliqua</h2> <!-- appending -text to the cms-editable tag limits the wysiwyg editor -->
    ...
    <section class="gallery">  <!-- easy cheesy gallery -->
    	<div class="container_12 clearfix">
            ...
            <img src="http://placehold.it/140&text=Image" class="grid_2" alt="image" class="cms-editable-text" id="galleryImg_1">
            ...
            <img src="http://placehold.it/140&text=Image" class="grid_2" alt="image">
            <img src="http://placehold.it/140&text=Image" class="grid_2" alt="image">
        </div>	<!-- Yes Yes I know this doesnt include any fancy lightbox stuff. But your a rockstar developer, you add it. -->
    </section>
